...
This is a simple full stack [React](https://reactjs.org/) application with a [Node.js](https://nodejs.org/en/) and [Express](https://expressjs.com/) backend. Client side code is written in React and the backend API is written using Express. This application is configured with [Standardjs ESLint rules](https://standardjs.com) and formatted through [prettier](https://prettier.io/).
...
git clone https://github.com/wirthhorn/exercise
...
[I am using Standardjs Javascript Style Guide](https://standardjs.com). Since we are going to write both client (browser) and server side (Node.js) code, I am setting the **env** to browser and node. Optionally, we can override the Standardjs configurations to suit our needs.
